...
import { renderFlipkartReport } from "./flipkart.report.js";
import { loadAllData } from "../../core/data-loader.js";

/* ======================================================
   BUILD FLIPKART FC MAP
====================================================== */
async function buildFlipkartFcMap() {
  const rows = getFlipkartRows();

  const data = await loadAllData(() => {});
  const flipkartFcStock = data.fcStock.filter(
    r => r.mp === "FLIPKART"
  );
...
/* ======================================================
   MAIN RENDER
====================================================== */
export async function renderFlipkartSummaries() {
  const container = document.getElementById("tab-content");
  const fcMap = await buildFlipkartFcMap();
